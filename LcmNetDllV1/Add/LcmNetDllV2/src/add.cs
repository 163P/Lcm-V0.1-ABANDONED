...
* Date: Fri May 27 22:49:38 2016
* Arguments: "-B" "macro_default" "-W" "dotnet:LcmNetDllV2,add,0.0,private" "-T"
* "link:lib" "-d" "E:\LcmNetDllV1\Add\LcmNetDllV2\src" "-w"
* "enable:specified_file_mismatch" "-w" "enable:repeated_file" "-w"
* "enable:switch_ignored" "-w" "enable:missing_lib_sentinel" "-w" "enable:demo_license"
* "-v"
* "class{add:E:\LcmNetDllV1\Add\Add.m,E:\LcmNetDllV1\Add\Add2.m,E:\LcmNetDllV1\Add\mat_add
* .m}" 
*/
using System;
...
namespace LcmNetDllV2
{

  /// <summary>
  /// The add class provides a CLS compliant, MWArray interface to the M-functions
  ...
  public class add : IDisposable
  {
    ...
    static add()
    {
      if (MWMCR.MCRAppInitialized)
      {
        ...
        string ctfFileName = "LcmNetDllV2.ctf";
