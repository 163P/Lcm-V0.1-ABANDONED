...
P:
        ...
        If Lyric <> "R" Then
            ...
            A = LL.LengthChange(1, SingerDir & "\SoundSource\" & wav, SLength * 2, SingerDir & "\Cache\" & No & ".wav", mFen * 3, start, Send, consonant, SingerDir & "\Cache\", 0.1)
            Try
        ...
        Else
            ...
            If Dir(SingerDir & "\Cache\" & No & ".wav") = "" Then
                ...
                A = LL.LengthChange(1, SingerDir & "\Cache\" & No & ".wav", SLength * 2, SingerDir & "\Cache2\" & No + 1 & ".wav", mFen * 3, start, Send, consonant, SingerDir & "\Cache\", 0.1)
                ' Kill(SingerDir & "\Cache\" & No & ".wav")
                'If No = 3 Then
                'A = LA.Add(1, SingerDir & "\Cache2\" & No - 1 & ".wav", SingerDir & "\Cache2\" & No & ".wav", SingerDir & "\Cache3\a.wav")
                ' End If
            End If
            A = LL.LengthChange(1, SingerDir & "\SoundSource\" & wav, SLength * 2, SingerDir & "\Cache2\" & No + 1 & ".wav", mFen * 3, start, Send, consonant, SingerDir & "\Cache\", 0.1)
        End If
        '  mFen = 3
