Module Module2
    ...
    'End Function
    Sub UST(ByVal UstName As String, ByVal SingerDir As String, ByVal Notenums As Integer, Engine As String,Parameter As String )
...
P:
        ...
        If Lyric <> "R" Then
            ...
            Shell(Engine & "  """ & SingerDir & "\SoundSource\" & wav & """ """ & SingerDir & "\Cache2\" & No + 1 & ".wav"" " & Tall & " 100 ""/" & Parameter & """ " & start & " " & SLength * 1000.ToString & " " & Send.ToString & " " & consonant.ToString & " 100 0 !" & bpm)
