...
P:
        ...
        '
        'End If
        Tall = GetINI("#List", NoteNum, "C4", SingerDir & "/pitch.ini")
        'If Lyric = "R" Then
        ...
        If Lyric <> "R" Then
            ...
            Shell("tn_fnds.exe  """ & SingerDir & "\SoundSource\" & wav & """ """ & SingerDir & "\Cache2\" & No + 1 & ".wav"" " & Tall & " 100 ""/e"" " & start & " " & SLength * 1000.ToString & " " & Send.ToString & " " & consonant.ToString & " 100 0 !" & bpm)
        ...
        Else
            ...
            Shell("tn_fnds.exe  """ & SingerDir & "\SoundSource\" & wav & """ """ & SingerDir & "\Cache2\" & No + 1 & ".wav"" " & Tall & " 100 ""/e"" " & start & " " & SLength * 1000.ToString & " " & consonant.ToString & " " & Send.ToString & " 100 0 !" & bpm)
